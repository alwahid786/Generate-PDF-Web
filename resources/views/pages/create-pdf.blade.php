                    ...
                    <div class="project-input-wrapper">
                        <div class="pdf-info-input-wrapper">
                            ...
                            <div class="pdf-info-input">
                                <input type="text" name="project" value="{{ $packageInfo->package_name ?? '' }}"
                                    id="projectName" class="typeValidation">
                ...
                <div class="create-pdf-lower-body mt-5">
                    ...
                    <div class="lower-body-input-wrapper">
                        ...
                        <div class="drop-zone">
                            ...
                            <span>Drag + Drop</span>
                            <input type="file" name="pdf-file" id="pdfFile" class="drop-zone__input typeValidation"
                                accept="*">
                        </div>
                            ...
                            @foreach ($packageInfo->fixtures as $fixture)
                                <ul class="mt-4 row{{ $fixture['id'] }}" data-id="{{ $fixture['id'] }}">
                                    ...
                                    <li class="d-flex align-items-center justify-content-end">
                                        <img style="cursor:pointer; width:28px;height:28px;" class="editPdfBtn"
                                            src="{{ asset('public/assets/images/edit-icon.svg') }}" alt="image">
                                        <img style="cursor:pointer;" class="removePdfBtn ml-2"
                                            src="{{ asset('public/assets/images/delete.png') }}" alt="image">
                                    </li>
                                </ul>
                            @endforeach
                        @endif
